...
public class frameLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SILAHKAN LOGIN USER YANG SUDAH DI DAFTAR");
...
//       login.addId(txtuser.getText());
//       login.addPassword(txtpass.getText());
//       
        if (txtuser.getText().contains("user") && txtpass.getText().contains("user123")) {
        new frameProduk().setVisible(true);
        } else {
            String pesan = "GAGAL LOGIN ";
            JOptionPane.showConfirmDialog(this, pesan);
        }
